...
namespace OldDownlink
{
    ...
    public class Model
    {
        ...
        public Downlink.Model.ModelCase TheCase = Downlink.Model.ModelCase.Rails;
        ...
        public class Driver
        {
            ...
            public void EvalImage(Packet p)
            {
                ...
                if (TheModel.TheCase == Downlink.Model.ModelCase.Rails)
                ...
                foreach (var frag in f.Fragments)
                    if (frag.IsFinal)  // Assumes no packet loss, for now
                    {
                        ...
                        if (packet.APID == APID.DOCWaypointImage)
                        {
                            ...
                            if (TheModel.TheCase == Downlink.Model.ModelCase.ScienceStation && di.SequenceNumber == 3 && di.RoverPosition == TheModel.TheRover.Position)
                            {
    ...
    public class SimpleModel : Model
    {
        ...
        public override void Start()
        {
            ...
            if (TheCase == Downlink.Model.ModelCase.Rails)
